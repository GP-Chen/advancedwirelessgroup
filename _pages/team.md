---
title: "Advanced Wireless Systems Group - Team"
layout: gridlay
excerpt: "Advanced Wireless Systems Group: Team members"
sitemap: false
permalink: /team/
---
...
Jump to [staff](#staff),  [PhD Students](#phd-students), [Alumni](#alumni), [Notes to prospective students](#notes-to-prospective-students).
...
<div class="col-sm-6 clearfix">
  <img src="{{ site.url }}{{ site.baseurl }}/images/teampic/{{ member.photo }}" class="img-responsive" width="25%" style="float: left" />
  <h4>{{ member.name }}</h4>
  <i>{{ member.info }}<br>{{ member.duration }}<br>{{ member.now }}</i>
  <ul style="overflow: hidden">
...
If you want to join our group, please send an email with your CV to [Prof. Liew](#staff).
